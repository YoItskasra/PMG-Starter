...
class OnboardingService {
   ...
   */
  async startOnboarding(boardId: string, baseUrl: string): Promise<OnboardingState> {
   ...
   */
  async getOnboardingState(boardId: string): Promise<OnboardingState | undefined> {
   ...
   */
  async getActiveOnboardings(): Promise<OnboardingState[]> {
   ...
   */
  async completeOnboarding(boardId: string): Promise<OnboardingState | undefined> {
   ...
   */
  async getProgress(boardId: string): Promise<{
    totalTasks: number;
