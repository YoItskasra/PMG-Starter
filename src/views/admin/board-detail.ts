...
const statusBadge = (status: MondayBoard["status"]): string => {
...
const taskTypeBadge = (type: MondayTask["type"]): string => {
...
const taskStatusIcon = (status: MondayTask["status"]): string => {
...
export const boardDetailView = (data: BoardDetailData): string => `
